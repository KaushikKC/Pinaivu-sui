  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-zinc-100 mb-1">Usage</h1>
          <p className="text-zinc-500 text-sm">Last {days} days</p>
        </div>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-surface-2 text-left text-zinc-500 text-[11px] uppercase tracking-wide">
                  ...
                  <th className="pb-3 pr-4">In tokens</th>
                  <th className="pb-3 pr-4">Out tokens</th>
                  <th className="pb-3 pr-4">Latency</th>
                  <th className="pb-3">Cost (X)</th>
                </tr>
              </thead>
              <tbody>
      ...
      {!summary && (
        <p className="text-zinc-600 text-sm">No usage data for this period.</p>
      )}
    </div>
  );
}
