...
export default function CreateKeyForm({ accountId, onCreated }: { accountId: string; onCreated: () => void }) {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button onClick={handleCreate} disabled={loading} className="px-4 py-2.5 bg-accent hover:bg-accent-hover disabled:opacity-50 text-white text-sm rounded-xl transition-colors">
